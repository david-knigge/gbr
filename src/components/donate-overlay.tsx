        ...
        <div className="px-5 pb-8 space-y-4">
          ...
          <div className="bg-white border border-card-border rounded-xl p-4">
            ...
            <div className="space-y-2.5">
              <div className="flex items-start gap-3">
                <span className="text-coral font-bold text-sm w-10">$5+</span>
                <span className="text-sm text-foreground">
                  +5 raffle entries
                </span>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-coral font-bold text-sm w-10">$20+</span>
                <div className="text-sm text-foreground">
                  +15 entries
                  <span className="block text-xs text-teal font-medium">
                    + 2x rewards on your next 3 checkpoints
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-coral font-bold text-sm w-10">$50+</span>
                <div className="text-sm text-foreground">
                  +50 entries
                  <span className="block text-xs text-teal font-medium">
                    + Donor badge
          ...
          {user && (
            <div className="bg-teal/5 border border-teal/20 rounded-xl p-4 text-center">
              <p className="text-xs text-muted mb-1">Your Donation Code</p>
              <div className="text-2xl font-mono font-bold text-foreground tracking-wider">
                {user.app_code}
              </div>
              <CopyButton text={user.app_code} className="mt-1" />
          ...
          {showRaffle && (
            <div className="space-y-2">
              <input
                ...
                className="w-full px-3 py-2 border border-card-border rounded-lg text-sm bg-white"
              />
              <input
                type="email"
                value={email}
